...
void ElaTabWidget::setIndicatorPosition(ElaTabBarType::IndicatorPosition pos)
{
    Q_D(ElaTabWidget);
    d->_tabBar->setIndicatorPosition(pos);
}

ElaTabBarType::IndicatorPosition ElaTabWidget::getIndicatorPosition() const
{
    Q_D(const ElaTabWidget);
    return d->_tabBar->getIndicatorPosition();
}
